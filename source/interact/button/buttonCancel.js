...
import { HANDLE_BUTTON_APPROVE, HANDLE_BUTTON_CANCEL, HANDLE_BUTTON_REJECT, NAME_ANONYMOUS, NAME_IDENTIFY, STATUS_PENDING } from "../config/nametag.js";
import { embedAPPROVAL } from "../../utilities/embed.js";

export const name = HANDLE_BUTTON_CANCEL;
export const execute = asyncErrorHandler(async (interaction) => {
    ...
    const cfsID = parseInt(interaction.customId.replace(HANDLE_BUTTON_CANCEL, ''));
